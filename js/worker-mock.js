...
function postRandomData() {
	...
	if (!showError) {
		data.chart = {cpuSystem, cpuProcess};
	}

	self.postMessage(data);
}

function getRandomLine({ showError, cpuSystem, cpuProcess}) {
